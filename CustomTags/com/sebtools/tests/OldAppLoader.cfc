...
<cffunction name="getComponents" access="public" returntype="array" output="no">
	...
	<cfset Variables.TimeLoaded = now()>
...
<cffunction name="getWhenComponentsLoaded" access="public" returntype="any" output="no">
	<cfreturn Variables.TimeLoaded>
</cffunction>
